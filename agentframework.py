...
#Import the random operator which will be used to initiat the agents
import random 
...
class Agent ():
    ...
    def share_with_neighbours(self, neighbourhood):
        ...
        for agent in self.agents:
            ...
            if distance <= neighbourhood:
                ...
                self.store = ave
                agent.store = ave
                #print("sharing " + str(distance) + " " + str(ave)) to test the distance which make the agent share stor
    ...
    """
    This characteristic and behaviour of the agents can be improved by 
    1. Excluding the agent to share with itself 
    2. The moving is random and it can be predefined instead based on condition.
    """
