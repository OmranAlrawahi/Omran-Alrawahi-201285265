...
Brief :
This model is agent-based model (ABM) creating agents in an environment and make them interact with each other based on predefined conditions.
Elements: 
...
This model is can be used to simulate many agent-based phenomena, it can be used as a green landscape (environment) has some animals eating from the environment and storing some resources. 
The animals are moving in the environment and sharing their stored resources with their neighbors based on predefined conditions.
Way forward:
This model can be improved by adding more limitation to the agents move and sharing condition as well as adding more than one type of agents. To interact with each other’s. 
